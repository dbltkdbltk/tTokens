...
const issuer_name = 'Неизвестный Безымянный Банк Zero';
const contract_address = '0x9ed6a23b7264A1b19e0F4e9d38047b3E87Ba1F5a'; // Sepolia test network, the checksum address, contract0
const contract_alias = 'unb0';
const mongo_pwd =  '{J}2KE+aF+m';
const tcp_port = 8000;
const issuer_key = '0xd38b0884bc80a3627aa11b82c73b70bb990cd8ed4b7ee6e9956ffa2689d8d515';
//
//const issuer_name = 'Неизвестный Безымянный Банк One';
//const contract_address = '0x51ECB7625F269045139fCC6D93a03F6553D6CDFA'; // Sepolia test network, the checksum address, contract1
//const contract_alias = 'unb1';
//const mongo_pwd = '}AodJ($}qN8';
//const tcp_port = 8100;
//const issuer_key =  '0x127cbdf98a1cfe3efffd610517771a2a6a1d486c14e2660bd551b1a25b62df28';

const myProvider = 'https://sepolia.infura.io/v3/84b37cacaeac4fa1bee01326f6af5b52'// Sepolia test network
const minter = '0x35503B7013a79257A8aa91451A1e7861109FD2E7';
const minter_key = '0xbaee3e7d2996511a7b5f5bf81479976a9c261a38812cb07b779df07ec49baeaf';
const gas_limit = 5000000;
const ssl_key = './ca/localhost.key';
const ssl_cert = './ca/localhost.crt';
